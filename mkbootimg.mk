...
INSTALLED_DTIMAGE_TARGET := $(TOP)/device/samsung/gtexsltedd/dt.img
...
# 	$(hide) cd $(TOP)/kernel/samsung/gtexslte && $(DTBTOOL) -o $(INSTALLED_DTIMAGE_TARGET) -p $(KERNEL_OUT) -i $(TOP)/kernel/samsung/gtddexslte/arch/arm/boot/dts/
